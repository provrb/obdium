        ...
        spawn(async move {
            loop {
                ...
                update!(
                    ...
                    "Relative Throttle Pos." => relative_throttle_pos,
                    "Abs. Throttle Pos. (D)" => abs_throttle_pos_b,
                    "Abs. Throttle Pos. (C)" => abs_throttle_pos_c,
                    "Accelerator Pedal Pos. (D)" => acc_pedal_pos_d,
