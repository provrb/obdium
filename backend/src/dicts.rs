...
pub const PID_INFOS: &[PidInfo] = &[
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "kPa",
        pid_name: "Intake manifold absolute pressure",
        formula: "A",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "°C",
        pid_name: "Intake air temperature",
        formula: "A - 40",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "s",
        pid_name: "Run time since engine start",
        formula: "(256 * A) + B",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "(ratio, V)",
        pid_name: "Oxygen Sensor 1 (AB: AFR CD: Voltage)",
        formula: "(ratio: 2/65536(256A+B) V: 8/65536(256C+D)",
    },
    PidInfo {
        supported: false,
        pid: "25",
        mode: "01",
        unit: "(ratio, V)",
        pid_name: "Oxygen Sensor 2 (AB: AFR CD: Voltage)",
        formula: "(ratio: 2/65536(256A+B) V: 8/65536(256C+D)",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "(ratio, V)",
        pid_name: "Oxygen Sensor 3 (AB: AFR CD: Voltage)",
        formula: "(ratio: 2/65536(256A+B) V: 8/65536(256C+D)",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "(ratio, V)",
        pid_name: "Oxygen Sensor 4 (AB: AFR CD: Voltage)",
        formula: "(ratio: 2/65536(256A+B) V: 8/65536(256C+D)",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "(ratio, V)",
        pid_name: "Oxygen Sensor 5 (AB: AFR CD: Voltage)",
        formula: "(ratio: 2/65536(256A+B) V: 8/65536(256C+D)",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "(ratio, V)",
        pid_name: "Oxygen Sensor 6 (AB: AFR CD: Voltage)",
        formula: "(ratio: 2/65536(256A+B) V: 8/65536(256C+D)",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "(ratio, V)",
        pid_name: "Oxygen Sensor 7 (AB: AFR CD: Voltage)",
        formula: "(ratio: 2/65536(256A+B) V: 8/65536(256C+D)",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "(ratio, V)",
        pid_name: "Oxygen Sensor 8 (AB: AFR CD: Voltage)",
        formula: "(ratio: 2/65536(256A+B) V: 8/65536(256C+D)",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "%",
        pid_name: "Commanded evaporative purge",
        formula: "100/255 * A",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "km",
        pid_name: "Distance traveled since codes cleared",
        formula: "(256 * A)+B",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "°C",
        pid_name: "Catalyst Temperature: Bank 1, Sensor 1",
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "°C",
        pid_name: "Catalyst Temperature: Bank 2, Sensor 1",
        formula: "(((256 * A)+B) / 10) - 40",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "°C",
        pid_name: "Catalyst Temperature: Bank 1, Sensor 2",
        formula: "(((256 * A)+B) / 10) - 40",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "°C",
        pid_name: "Catalyst Temperature: Bank 2, Sensor 2",
        formula: "(((256 * A)+B) / 10) - 40",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "%",
        pid_name: "Relative throttle position",
        formula: "100/255 * A",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "°C",
        pid_name: "Ambient air temperature",
        formula: "A - 40",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "%",
        pid_name: "Absolute throttle position B",
        formula: "100/255 * A",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "g/s",
        pid_name: "Max. air flow rate from MAF sensor",
        formula: "A * 10",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "°C",
        pid_name: "Engine oil temperature",
        formula: "A - 40",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "%",
        pid_name: "Driver's demand engine - percent torque",
        formula: "A - 125",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "%",
        pid_name: "Actual engine - percent torque",
        formula: "A - 125",
    },
    PidInfo {
        supported: false,
        ...
        mode: "01",
        unit: "Nm",
        pid_name: "Engine reference torque",
        formula: "256A + B",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "",
        pid_name: "Actual EGR, Commanded EGR, and EGR Error",
        formula: "",
    },
    PidInfo {
        supported: false,
    ...
    PidInfo {
        ...
        mode: "01",
        unit: "",
        pid_name: "Engine run time for Auxiliary Emissions Control Device(AECD)",
        formula: "",
    },
    PidInfo {
        supported: false,
